...
public class HpkpRoPolicy implements Serializable
{
    ...
    private final static long serialVersionUID = 6094624674861778216L;
     ...
     * @param matchedPins
     */
    public HpkpRoPolicy(String status, ArrayList<Object> pins, ArrayList<Object> matchedPins, ArrayList<Object> directives)
    {
        super();
        this.status = status;
        this.pins = pins;
